...
RSpec.describe BackfillConstituenciesJob, type: :job do
  context "when the constituency_id column is nil" do
    let(:signature) { FactoryGirl.create(:validated_signature, constituency_id: nil) }
  ...
  context "when the constituency_id column is not nil" do
    let(:signature) { FactoryGirl.create(:validated_signature, constituency_id: "1234") }
  ...
  context "when limited in scope by id" do
    let!(:signature_1) { FactoryGirl.create(:validated_signature, constituency_id: nil) }
    let!(:signature_2) { FactoryGirl.create(:validated_signature, constituency_id: nil) }
  ...
  context "when limited in scope by date" do
    let!(:signature_1) { FactoryGirl.create(:validated_signature, constituency_id: nil, validated_at: 2.weeks.ago) }
    let!(:signature_2) { FactoryGirl.create(:validated_signature, constituency_id: nil, validated_at: 1.day.ago) }
  ...
  context "when limited in scope by id and date" do
    let!(:signature_1) { FactoryGirl.create(:validated_signature, constituency_id: nil, validated_at: 2.weeks.ago) }
    let!(:signature_2) { FactoryGirl.create(:validated_signature, constituency_id: nil, validated_at: 1.day.ago) }
    let!(:signature_3) { FactoryGirl.create(:validated_signature, constituency_id: nil, validated_at: 1.day.ago) }
